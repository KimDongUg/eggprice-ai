...
from app.api import accuracy, news, analysis, data, community, page_views, admin_manage, cron
...
from app.models import community as community_models  # noqa: F401
...
app.include_router(page_views.router, prefix="/api/v1")
